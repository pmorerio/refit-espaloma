...
python ${SCRIPT_PATH}/getgraph_hdf5.py --hdf5 ${DATASET_PATH}/PEPCONF-DLC-OPTIMIZATION-DATASET-OPENFF-DEFAULT.hdf5 --output_prefix "mydata" --keyname "@@@KEYNAME@@@" --index @@@INDEX@@@
