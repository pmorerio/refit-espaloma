...
python esp_test.py --layer $layer --units $units --activation $activation --config "$config" --janossy_config "$janossy_config" \
       --input_prefix $input_prefix --datasets="$datasets" --checkpoint_path $checkpoint_path --epoch 1400
